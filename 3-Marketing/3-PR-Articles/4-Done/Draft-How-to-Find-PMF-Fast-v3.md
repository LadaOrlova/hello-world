...
> **Статус:** Черновик v3 (style-only rewrite)
...
> **Что изменено vs оригинала:** Только хук, переходы между секциями, close, ритм абзацев. Все кейсы, ссылки, логика и структура — из Ваниного драфта.
